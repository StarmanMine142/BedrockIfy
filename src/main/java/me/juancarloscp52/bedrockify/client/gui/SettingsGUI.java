...
public class SettingsGUI {
    ...
    public Screen getConfigScreen(Screen parent){
        ...
        builder.setDefaultBackgroundTexture(Identifier.of("minecraft:textures/block/bedrock.png"));
        // Create Categories
        ...
        */
         ...
         */
            ...
            screenSafeArea.add(entryBuilder.startIntSlider(Text.translatable("bedrockify.options.screenSafeArea"), settingsClient.screenSafeArea,0,30).setDefaultValue(2).setSaveConsumer((newValue)-> settingsClient.screenSafeArea=newValue).build());
